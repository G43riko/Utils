	...
	if (arguments.length === 0) {
		...
		if (G.isString(arguments[0])) {
			...
			G.each(arguments[0], function (e) {
				if (G.isElement(e)) {
					_this.elements[_this.elements.length] = e;
				}
			});
...
var tests = function tests(G) {
	...
	body.append(G.createElement("div", { id: "rodic" }, [G.createElement("div", { class: "aaa" }), G.createElement("div", { class: "aaa" }, G.createElement("ul", {}, [G.createElement("li"), G.createElement("li", { class: "temno" }, "temno vnutorne"), G.createElement("li"), G.createElement("li")])), G.createElement("div", { class: "aaa" })]));
 ...
 */
	...
	if (G.isFunction(options.loadEnd)) {
		http.onloadend = function () {
			return options.loadEnd(G.now() - start);
		};
	}
...
G.children = function (element) {
	var condition = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "*";
	//testovane 28.1.2017 //deprecated since 29.1.2017, poižiť G.childrens
...
G.prototype.add = function () {
	...
	G.each(arguments, function (e, i) {
		if (G.isElement(e)) {
			_this2.elements[_this2.elements.length] = e;
...
G.prototype.equalAll = function (obj) {
	...
	G.each(obj.elements, function (e) {
		if (_this4.elements.indexOf(e) < 0) {
			return false;
		}
	});
...
G.prototype.parentsUntil = function () {
	var selectorString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
	//testovane 28.1.2017
	return new G(G.parents({
		element: this.first(),
...
G.prototype.nextUntil = function () {
	var selectorString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
	//TODO otestovať
	return new G(G.next({
		element: this.first(),
...
G.prototype.prevUntil = function () {
	var selectorString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
	//TODO otestovať
	return new G(G.prev({
		element: this.first(),
...
G.prototype.children = function () {
	var selectorString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
	//deprecated 11.2.2017
	return this.childrens(selectorString);
};
G.prototype.childrens = function () {
	var selectorString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
...
G.prototype.append = function (data) {
	//testovane 28.1.2017 //testovane 29.1.2017
	if (this.isEmpty()) {
		return this;
	}
...
G.prototype.delay = function (func) {
 ...
 * @returns {*}
 */
G.prototype.text = function (text) {
...
G.prototype.html = function (html) {
	//testovane 26.1.2017 //testovane 29.1.2017
...
G.prototype.delete = function () {
	//TODO otestovať - pridať možnosť filtrovať vymazane //testovane 29.1.2017
	if (this.isEmpty()) {
		return this;
	}
...
G.prototype.undelegate = function (listener, func) {
	//TODO otestovať
	this.unbind(listener, func);
};

G.prototype.delegate = function (condition, listener, func) {
	//TODO otestovať
	if (G.isString(condition)) {
		this.bind(listener, function (e) {
